...
client = pymongo.MongoClient("mongodb://localhost:27017/carpriceprediction")
...
url = "https://ikman.lk/en/ads/sri-lanka/cars?sort=date&order=desc&buy_now=0&urgent=0&page="
...
schedule.every().day.at("11:53").do(scrape_and_insert)
